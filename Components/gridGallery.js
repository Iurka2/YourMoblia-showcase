...
const GridGallery = ({img1, img2, img3, img4,img5,img6,img7,img8 }) => {
  ...
  <div className={styles.container}>
        ...
        <motion.div className={styles.item1} whileHover={{scale:1.01}}>
        ...
        <motion.div className={styles.item2} whileHover={{scale:1.01}}>
         ...
         <motion.div className={styles.item4} whileHover={{scale:1.01}}>
         <Zoom wrapStyle={{ maxWidth: "100%" }}>
           <Image  layout='responsive'  alt="photo of bathroom"   src={img4} className={styles.pic}  />
          </Zoom>
         </motion.div>

         <motion.div className={styles.item5} whileHover={{scale:1.01}}> 
         <Zoom wrapStyle={{ maxWidth: "100%"}}>
         ...
         <motion.div className={styles.item6} whileHover={{scale:1.01}}>
         <Zoom wrapStyle={{ maxWidth: "100%" }}>
         ...
         <motion.div className={styles.item7} whileHover={{scale:1.01}}>
         <Zoom wrapStyle={{ maxWidth: "100%" }}>
         ...
         <motion.div className={styles.item8} whileHover={{scale:1.01}}>
         <Zoom wrapStyle={{ maxWidth: "100%" }}>
